...
class YagerOWAOptimalSolution(OWAOptimalSolution):
    def __init__(self, data_yager_owa):
        super().__init__(data_yager_owa)
        # self.a_owa_min = data_yager_owa[5]
        # self.b_owa_min = data_yager_owa[6]
        # self.a_owa_max = data_yager_owa[7]
        # self.b_owa_max = data_yager_owa[8]
    ...
    def calculate_max_x(self):
        ...
        for j in range(self.n):
            ...
            owa_val = .0
            if len(cap_i_bar) > 0:
                weights_min = self.calculate_owa_weights_linguistic(self.a_owa_min, self.b_owa_min, len(cap_i_bar))
    ...
    def calculate_optimal_x(self, i_index_sets_star):
        ...
        for index in i_index_sets_star:
            ...
            weights_max = self.calculate_owa_weights_linguistic(self.a_owa_max, self.b_owa_max, len(b_low_index))
            owa_val = 0.0
